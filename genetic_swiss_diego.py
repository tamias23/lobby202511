...
# Parse CLI arguments
parser = argparse.ArgumentParser(description="QuickDiego Genetic Algorithm Evolution (Swiss Tournament)")
...
parser.add_argument("--diego_mcts_budget", type=int, default=100, help="MCTS budget in ms for color look-ahead (default: 100)")
...
async def main():
    print(f"Initializing {args.agents} random QuickDiego agents (Swiss System)...")
    ...
    table_filename = "swiss_tournament_diego_table.csv"
    ...
    csv_filename = "greedy_diego_results_swiss.csv"
