...
# Parse CLI arguments
parser = argparse.ArgumentParser(description="QuickDiego Genetic Algorithm Evolution")
...
async def main():
    print(f"Initializing {args.agents} random QuickDiego agents...")
    ...
    csv_filename = "greedy_diego_results.csv"
    with open(csv_filename, 'w', newline='') as csvfile:
        csvwriter = csv.writer(csvfile)
        
        header = ["Rank", "AgentID", "Name", "Score"] + [f"Weight_{i}" for i in range(NUM_PARAMS)]
