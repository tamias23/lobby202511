            ...
            const response = await fetch('/api/moves', {
                ...
                body: JSON.stringify({
                    ...
                    piecesJson: JSON.stringify(allPieces.map(p => {
                        ...
                        if (mappedType === 'heroe') mappedType = 'king';
                        if (mappedType === 'witch') mappedType = 'bishop';
                        if (mappedType === 'golem') mappedType = 'berserker';
                        return {
                            id: p.id,
                            type: mappedType,
...
function getFullBoardPieces() {
    ...
    // Add some witchs
    pieces.push({id: 'white_witch_0', type: 'witch', pos: 'gH2'});
    pieces.push({id: 'white_witch_1', type: 'witch', pos: 'gG1'});
    pieces.push({id: 'black_witch_0', type: 'witch', pos: 'yI1'});
    pieces.push({id: 'black_witch_1', type: 'witch', pos: 'yG1'});
