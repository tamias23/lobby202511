...
app.post('/login', async (req, res) => {
    ...
    try {
        ...
        res.json({
            ...
            rating_bullet: Math.round(user.rating_bullet || 1500),
            rating_blitz: Math.round(user.rating_blitz || 1500),
            rating_rapid: Math.round(user.rating_rapid || 1500),
            rating_classical: Math.round(user.rating_classical || 1500),
