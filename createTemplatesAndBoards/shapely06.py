...
for tryAndCreateTemplate in range(0, 10): # 167 1000
    ...
    noPointsHaveBeenMerged = True
    while sizeDict > 0:
        sizeDict = mergeClosePointsC(d)
        noPointsHaveBeenMerged = False
    ...
    # -----------------------------------------------------------------------------------------
    if ((len(allPolygons) > 90) and noPointsHaveBeenMerged):
        compteur = 0
        anotherCompteur = 0
