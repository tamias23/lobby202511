...
parser.add_argument("--duration", type=int, default=4000, help="Total duration to run the loop in seconds (default: 30mn)")
...
parser.add_argument("--train_epochs", type=int, default=15, help="Number of training epochs per batch")
parser.add_argument("--train_batch_size", type=int, default=32, help="Batch size for training the GAT model")
parser.add_argument("--max_data_files", type=int, default=4000, help="Maximum number of game JSON files to keep in mcts_temp")
