...
parser.add_argument("--duration", type=int, default=54000, help="Total duration to run the loop in seconds (default: 30mn)")
parser.add_argument("--games_per_batch", type=int, default=1800, help="Total number of games to play per training step")
...
parser.add_argument("--train_epochs", type=int, default=10, help="Number of training epochs per batch")
parser.add_argument("--train_batch_size", type=int, default=128, help="Batch size for training the GAT model")
parser.add_argument("--max_data_files", type=int, default=10800, help="Maximum number of game JSON files to keep in mcts_temp")
