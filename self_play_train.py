...
parser.add_argument("--games_per_batch", type=int, default=2000, help="Total number of games to play per training step")
...
parser.add_argument("--max_data_files", type=int, default=6000, help="Maximum number of game JSON files to keep in mcts_temp")
