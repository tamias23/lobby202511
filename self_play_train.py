...
parser.add_argument("--duration", type=int, default=80000, help="Total duration to run the loop in seconds (default: 30mn)")
...
parser.add_argument("--max_data_files", type=int, default=840, help="Maximum number of game JSON files to keep in mcts_temp")
