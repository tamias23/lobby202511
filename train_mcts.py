...
def train(epochs=10, batch_size=64):
    ...
    # Fix intermediate shape metadata to prevent onnxruntime VerifyOutputSizes warnings.
    # GATConv attention produces {N,1} tensors but the tracer records them as {-1}.
    import onnx
    from onnx import shape_inference
    print("Running ONNX shape inference pass...")
